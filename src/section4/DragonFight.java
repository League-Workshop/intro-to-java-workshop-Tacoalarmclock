...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (playerHealth > 0 && dragonHealth > 0) { // this line of code keeps the battle going until someone's
			...
			// or a kick
			String returnYellKick;
			returnYellKick = JOptionPane.showInputDialog("do you want to 'yell' or 'kick'"); // 9. If they typed in
																								// "yell":
			if (returnYellKick.equals("yell")) {
				// -- Find a random number between 0 and 10 and store it in dragonDamage
				dragonDamageDone = new Random().nextInt(10);
				// -- Subtract that number from the dragon's health variable
				dragonHealth = dragonHealth - dragonDamageDone;
			}
			// 10. If they typed in "kick":
			if (returnYellKick.equals("kick")) {
				// -- Find a random number between 0 and 25 and store it in dragonDamage
				dragonDamageDone = new Random().nextInt(25);
				// -- Subtract that number from the dragon's health variable
				dragonHealth = dragonHealth - dragonDamageDone;
				// -- Subtract that number from the dragon's health variable
			}
			...
			playerDamageDone = new Random().nextInt(35);
			// 12. Subtract this number from the player's health
			playerHealth = playerHealth - playerDamageDone;

			JOptionPane.showMessageDialog(null,
					" you lost " + playerDamageDone + " the dragon lost " + dragonDamageDone + " health!");
			...
			JOptionPane.showMessageDialog(null,
					"Your health is " + playerHealth + ", the dragon's health is " + dragonHealth);
